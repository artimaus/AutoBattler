...
namespace AutoBattlerLib
{
    ...
    {
        public int EquipmentPrototypeId { get; set; } = -1;
        public EquipmentState State { get; set; } = EquipmentState.Pristine;
    }
    ...
    public class ItemComponent : IComponent
    {
        ...
        // ECS relationships
        public EntityId ParentBodyPart { get; set; } = new EntityId(-1);
        public EntityId ParentForm { get; set; } = new EntityId(-1);
    }
